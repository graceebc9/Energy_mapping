...
def train_spectral_model(X_train, num_clusters):
    ...
    return spectral_model_rbf, scaler, pca, labels_rbf, X_principal
...
def main():
    ...
    print(X_train.shape)
    spectral_model_rbf, scaler, pca, labels_rbf, X_principal = train_spectral_model(X_train, num_clusters)
    print('starting save ')
...
# export RUN_NAME='spectral_clustering_run_1'

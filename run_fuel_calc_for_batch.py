...
if __name__ == "__main__":
    ...
    if overlap=='Yes':
        ...
        onsud_path = os.environ.get('OVERLAP_ONSUD_PATH')
        label='overlap'
        batch_id = 'overlap'
    else:
...
# BATCH_PATH='/Users/gracecolverd/New_dataset/overlapping_pcs.txt'
...
# export OVERLAP_ONSUD_PATH='/Users/gracecolverd/New_dataset/postcode_attrs/ONSUD_Data_OVERLAP.csv'
